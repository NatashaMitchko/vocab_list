...
def _seed_all():
    ...
    user_1 = UserORM(username="Natasha", status=UserStatus.active, tier=UserTier.admin, password=test_pw, email="a@b.com")
    user_2 = UserORM(username="Nick", status=UserStatus.active, tier=UserTier.regular, password=test_pw, email="c@d.org")
    user_3 = UserORM(username="Alex", status=UserStatus.active, tier=UserTier.regular, password=test_pw, email="e@f.gov")
